...
public class GlideUtils {
     ...
     * @param imageView ImageView
     */
    public static void loadCircleImageUser(Context context, String url, ImageView imageView) {
        RequestOptions options = new RequestOptions()
                .centerCrop()
                .circleCrop()//设置圆形
                .placeholder(placeholderImage) //占位图
     ...
     */
 /*   public static void loadCircleWithBorderImage(Context context, String url, ImageView imageView, float borderSize, @ColorInt int borderColor) {
...
*/
     ...
     */
/*
    public static void loadRoundCircleImage(Context context, String url, ImageView imageView, float radius) {
        RequestOptions options = RequestOptions.bitmapTransform(
                new MultiTransformation<>(
                        new CenterCrop(),
                        new RoundedCornersTransformation(SizeUtils.px2dp(context, radius), 0, RoundedCornersTransformation.CornerType.ALL)
                ))
                .placeholder(placeholderImage) //占位图
                .error(errorImage);            //错误图
        Glide.with(context).load(url).apply(options).into(imageView);
